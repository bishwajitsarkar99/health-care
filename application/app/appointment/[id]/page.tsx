...
export default function AppointmentPage() {
  ...
  // Doctors Appionment Book List
  const fetchDoctorAppoinmentList = async () => {
    try {
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              <div className="text-center mb-6">
                <div className="relative w-24 h-24 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-4">
                  {doctor.image ? (
                    <Image
                      src={doctor.image}
                      alt="doctor"
                ...
                <p className="text-blue-600 text-sm">{doctor.education}</p>
              </div>
